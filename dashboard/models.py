...
class cust_registration_table(models.Model):
    ...
    contact1=models.IntegerField(null=True,blank=True,default=0)
    alt_contact = models.IntegerField(null=True, blank=True,default=0)
    dest_contact = models.IntegerField(null=True, blank=True,default=0)
